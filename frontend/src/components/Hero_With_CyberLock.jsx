...
import CyberLockVisualization from './CyberLock3D';

export default function HeroWithCyberLock() {
    ...
    <section className={`relative py-20 md:py-40 overflow-hidden transition-colors duration-300 ${
      ...
      {isDark && (
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute top-0 -right-40 w-80 h-80 bg-gradient-to-r from-blue-600 to-cyan-400 rounded-full mix-blend-screen filter blur-3xl opacity-20 animate-pulse" style={{ animationDelay: '2s' }}></div>
      ...
      <div className="relative z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-20 items-center mb-16">
            ...
            <div className={`transition-all duration-1000 transform ${
              ...
              <p className={`text-lg md:text-xl mb-8 leading-relaxed drop-shadow-md ${
                ...
                Military-grade encryption meets elegant simplicity. Our advanced cybersecurity platform protects your business with real-time threat detection and 24/7 monitoring.
              </p>
              ...
              <div className={`flex flex-col gap-4 mb-8`}>
                {[
                  ...
                  { icon: '⚡', text: 'Real-time AI-powered threat detection' },
                  { icon: '🛡️', text: '24/7 automated security monitoring' },
                  { icon: '🔄', text: 'Zero-trust security architecture' }
                ].map((feature, idx) => (
                  <div 
                    key={idx}
            ...
            {/* Right Side - 3D Cyber Lock Model */}
            <div className={`relative h-96 md:h-[500px] lg:h-[600px] transition-all duration-1000 transform ${
              ...
              <div className={`absolute inset-0 rounded-3xl overflow-hidden transition-all duration-300 ${
                isDark
                  ? 'bg-gradient-to-b from-slate-900/50 to-slate-900/20 border border-white/10'
                  : 'bg-gradient-to-b from-gray-100 to-gray-50 border border-gray-200'
              }`}>
                <CyberLockVisualization />
              </div>
              ...
              {/* Info Label */}
              <div className={`absolute bottom-4 left-4 right-4 p-4 rounded-xl backdrop-blur-md transition-all duration-300 z-10 ${
                isDark
                  ? 'bg-slate-900/80 border border-white/10'
                  : 'bg-white/80 border border-gray-300'
              }`}>
                <p className={`text-sm font-medium ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>
                  ✓ Advanced cyber lock system with real-time threat detection
                </p>
              </div>
            </div>
          </div>
          ...
          {/* Security Metrics */}
          <div className={`grid grid-cols-2 md:grid-cols-4 gap-6 transition-all duration-1000 transform delay-700 ${
            isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
          }`}>
            {[
              ...
              <div key={index} className={`p-6 rounded-2xl text-center transition-all duration-300 hover:-translate-y-1 ${
                isDark
                ...
                <div className={`text-2xl md:text-3xl font-bold mb-2 bg-clip-text text-transparent ${
                  isDark
