  ...
  const getColorScheme = () => {
    if (isDeepfake) {
      return {
        ...
        statusSubtext: 'This media appears to be artificially generated or manipulated'
      };
    } else {
      return {
        ...
        statusSubtext: 'This media appears to be genuine with no significant manipulation detected'
      };
    }
  };
    ...
    <div className={`space-y-6 p-6 rounded-2xl border-2 transition-all duration-500 ${colorScheme.bgColor} ${colorScheme.borderColor}`}>
      ...
      <div className="flex gap-6 items-start">
        ...
        <div className="flex-shrink-0">
          <div className="relative w-32 h-32">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center">
              ...
              <div className={`text-xs font-semibold mt-1 ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
                Confidence
              </div>
            </div>
          </div>
        ...
        <div className="flex-1">
          ...
          {/* Details Row */}
          <div className={`flex gap-4 pt-4 border-t ${isDark ? 'border-white/10' : 'border-gray-200'}`}>
            <div>
              <p className={`text-xs font-semibold uppercase tracking-wider ${isDark ? 'text-gray-500' : 'text-gray-500'}`}>
                Media Type
              </p>
              <p className={`text-sm font-bold mt-1 capitalize ${isDark ? 'text-white' : 'text-gray-900'}`}>
                {type}
              </p>
            </div>
            <div>
