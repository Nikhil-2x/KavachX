...
export default function RegisterPage({ onClose, onSwitchToLogin, onGoogleSuccess }) {
  ...
  const handleGoogleRegister = () => {
    setLoading(true);
    // Simulate Google registration - Replace with actual OAuth implementation
    setTimeout(() => {
      const mockUser = {
        name: 'Jane Doe',
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black bg-opacity-50 flex items-center justify-center p-4 overflow-y-auto">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-8 relative overflow-hidden my-8">
        ...
        <div className="relative z-10">
          ...
          <div className="mb-8 text-center">
            ...
            <p className="text-gray-600">Join KavachX and start today</p>
          </div>
